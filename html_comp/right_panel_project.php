    ...
    <div class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <a data-toggle="modal" class="btn btn-default btn-sm" data-target="#create_team_new" style="cursor:pointer;">Create Team</a><br/><br/>
                    ...
                    <ul class="nav">
                        ...
                        <ul class='nav tree' style='display: none;'>
                            ...
                            while ($teamrow = mysqli_fetch_array($team)) {
                                ...
                                echo "<li><form role='form' method='POST' action = ''>
                ...
                <p align="center">
                    ...
                    if (isset($_POST['view'])) {
                        ...
                        if ($owner == $user_id) {
                            ...
                            $member = mysqli_query($db_handle, ("SELECT DISTINCT a.id, a.user_id, a.member_status, b.first_name,b.last_name, b.rank, b.contact_no, b.email FROM teams as a join user_info as b where
