...
$teams_name_display = mysqli_query($db_handle, ("SELECT DISTINCT team_name, project_id 
    ...
    while ($teams_name_displayRow = mysqli_fetch_array($teams_name_display)) {
        ...
        echo "  <a class='btn-link' href='teams.php?project_id=$team_project_id&team_name=$team_name'><strong>" 
                    .ucfirst($team_name)."</strong>
                </a><br>";
    }
*/                            
                    ...
                    <?php
                        ...
                        $teams_name_display = mysqli_query($db_handle, ("select DISTINCT team_name, project_id from teams where user_id= '$user_id' AND project_id='$pro_id';"));
                            while ($teams_name_displayRow = mysqli_fetch_array($teams_name_display)) {
                                ...
                                echo "<a href='project.php?project_id=$team_project_id&team_name=$list_of_teams'>" . ucfirst($list_of_teams)."</a><br>";
                            }
                    ?>
                </div>
            </div>
