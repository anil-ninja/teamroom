<div class="bs-component">
                      ...
                      <p align="center"><font size="4">Private Projects</font></p><hr/>
                       <?php
					...
					$remaining_time_own = $minute." Mins" ;
                      ...
                      <p align="center"><font size="4">Public Projects</font></p><hr/>
                       <?php
                            ...
                            if (strlen($public_pr_title) > 25) {
								$prtitle = substr(ucfirst($public_pr_title),0,26)."....";
								} else {
									$prtitle = ucfirst($public_pr_title) ;
								}								   
