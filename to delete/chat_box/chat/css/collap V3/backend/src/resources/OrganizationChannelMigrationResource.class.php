...
class OrganizationChannelMigrationResource implements Resource {
    ...
    public function checkIfRequestMethodValid($requestMethod) {
		return in_array($requestMethod, array('get', 'post', 'options'));
    }
    ...
    public function post($resourceVals, $data) {  
        ...
        switch ($migrate) {
            ...
            default:
                $updateMigrationStatue = false;
                break;
        }

        if ($updateMigrationState){
            ...
            try {
                ...
                /* Insert into db */
                $result = $this -> orgMigrationdDAO -> updateByOrgIdChannel($migrationRequestobj);
        ...
        return array('code' => '6201', 
                        'data' => array(
                            'data-fields' => $this -> migrationRequest
                        )
        );
    ...
    private function getStatus() {
            ...
            $listOfOrgMigrationObjs = $this -> orgMigrationdDAO -> queryByOrgIdChannelName(
            																$this -> organization, 
                                                                            $this -> channel 
                                                                            );
