...
if ($_POST['all']) {
	...
	$notice1 = mysqli_query($db_handle, "(SELECT * FROM events WHERE p_c_id IN (SELECT p_c_id FROM involve_in WHERE user_id = '$user_id' and event_type NOT IN(8, 12, 18, 19, 20, 21, 22, 23, 24, 25, 28, 29, 30, 36, 37)) and event_creater != '$user_id' )
										 UNION
	...
	while($notice1row = mysqli_fetch_array($notice1)) {
		...
		switch($type){
			...
			case 4:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										...
										target='_blank'>".$challenge_title2."</a> on  ".$eventtime."
									</div>" ;
			...
			case 5:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										...
										target='_blank'>".$challenge_title3."</a> on  ".$eventtime."
									</div>" ;
			...
			case 6:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										...
										target='_blank'>".$challenge_title4."</a> on  ".$eventtime."
									</div>" ;
			...
			case 7:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										...
										target='_blank'>".$challenge_title5."</a> on  ".$eventtime."
									</div>" ;
			...
			case 10:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										<i class='icon-star'></i>
										<a href ='profile.php?username=".$uname."'>".$fname."</a>&nbsp; Created Challenge In Project
										...
										target='_blank'>".$challenge_title6."</a> on  ".$eventtime."
									</div>" ;
			...
			case 12:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										...
										target='_blank'>".$challenge_title8."</a> In 
			...
			case 16:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										...
										target='_blank' >".$challenge_title12."</a> on  ".$eventtime."
									</div>" ;
			...
			case 17:
				...
				$notice = $notice ."<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);' onclick=".update($user_id,$db_handle).">
										...
										target='_blank'>".$challenge_title13."</a> on  ".$eventtime."
									</div>" ;
			...
			case 28:
				$notice22 = mysqli_query($db_handle, " SELECT id FROM known_peoples where status = '1' and knowning_id = '$user_id' and requesting_user_id = '$creater' ;") ;
		...
		while ($notice25row = mysqli_fetch_array($notice25)) {
			...
			$notice = $notice . "<div class ='row-fluid' style='margin-top:10px; background : rgb(240, 241, 242);'>
									<i class='icon-bullhorn'> ". $reminders."</i> By : ".$rname." on " .$eventtime."
								</div>";
		}
echo $notice ;
}
