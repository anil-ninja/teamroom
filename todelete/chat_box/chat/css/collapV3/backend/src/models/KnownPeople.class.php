<?php
	...
	class KnownPeople{
		...
		private $lastActionTime;
			function function__construct( $requestingId,$knowingId,$lastActionTime,$requestingTimet,$status
		,$id = null)
		{
			$this->id = $id;
		...
		function getLastActionTime(){
			...
			function toString (){
			return $this -> id . ", " . $this ->requestingId.",".$this->lastActionTime.",".$this->requestingId.".".$this->knowingId.",".$this->status;}
			function toArray() {
			return array (
