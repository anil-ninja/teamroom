...
$displayb = mysqli_query($db_handle, "(SELECT DISTINCT a.stmt, a.response_pr_id, a.response_pr_creation, b.first_name, b.last_name, b.username from response_project as a join user_info as b 
                                        where a.project_id = '$id' and a.response_pr_creation > '$time' and a.user_id = b.user_id and a.blob_id = '0' and	a.status = '5')
                                        UNION
                                        ...
                                        where a.project_id = '$id' and a.response_pr_creation > '$time' and a.user_id = b.user_id and a.blob_id = c.blob_id and a.status = '5') ;");
    ...
    $data .= "<div id='commentscontainer'>
				<div class='comments clearfix'>
					...
					<div class='comment-text'>
						...
						<a href ='profile.php?username=" . $username_pr_comment . "'>
						" . ucfirst($frstnam) . " " . ucfirst($lnam) . "</a></span>&nbsp 
